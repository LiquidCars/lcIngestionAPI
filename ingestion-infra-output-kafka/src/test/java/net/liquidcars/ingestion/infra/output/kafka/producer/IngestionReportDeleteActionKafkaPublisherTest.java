...
public class IngestionReportDeleteActionKafkaPublisherTest {

    @InjectMocks
    private IngestionReportDeleteActionKafkaPublisher publisher;

    @Mock
    private KafkaTemplate<String, IngestionReportResponseActionMsg> kafkaTemplate;

    private static final String TOPIC = "liquidcars.ingestion.event.report.delete-action-result.0";
