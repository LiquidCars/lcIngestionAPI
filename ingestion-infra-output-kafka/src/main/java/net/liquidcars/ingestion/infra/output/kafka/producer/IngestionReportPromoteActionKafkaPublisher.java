...
public class IngestionReportPromoteActionKafkaPublisher {
    ...
    public void sendIngestionReportResponseAction(IngestionReportResponseActionMsg ingestionReportResponseActionMsg) {
        try {
            ...
            kafkaTemplate.send(REPORT_PROMOTE_ACTION_RESULT_TOPIC, ingestionReportResponseActionMsg.getIngestionReportId().toString(), ingestionReportResponseActionMsg).get();
        } catch (Exception e) {
