...
public class VehicleModelJSONModelTest {

    @Mock
    private KeyValueJSONModel mockKeyValue;

    @Test
    @DisplayName("Getters y Setters: Cobertura de campos de datos de Lombok")
    void testLombokData() {
        VehicleModelJSONModel model = TestDataFactory.createVehicleModelJSONModelWithData(123L, "BMW", "530D", 258, 5.8 , mockKeyValue);
    ...
    void testHashCode() {
        ...
        VehicleModelJSONModel model1 = TestDataFactory.createVehicleModelJSONModel();
        VehicleModelJSONModel model2 = new VehicleModelJSONModel();
    ...
    void testHashCodeWithNulls() {
        VehicleModelJSONModel model = TestDataFactory.createVehicleModelJSONModel();
    ...
    private void copyAllFields(VehicleModelJSONModel source, VehicleModelJSONModel target) {
