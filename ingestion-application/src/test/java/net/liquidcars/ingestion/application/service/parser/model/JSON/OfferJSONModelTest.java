...
public class OfferJSONModelTest {
    ...
    void shouldBeValidWhenAllCriteriaAreMet() {
        OfferJSONModel offer = TestDataFactory.createValidOfferJSONModel();
    ...
    void shouldBeInvalidWhenPriceIsIncorrect() {
        ...
        offer.setPrice(new MoneyJSONModel(null, null));
    ...
    void shouldValidatePrivateSellerContext() {
        OfferJSONModel offer = TestDataFactory.createValidOfferJSONModel();
        offer.setSellerType(CarOfferSellerTypeEnumJSONModel.usedCar_PrivateSeller);
    ...
    void testBuilder() {
        ...
        OfferJSONModel offer = OfferJSONModel.builder()
                .jsonCarOfferId(id)
                .guarantee(true)
                .build();
