...
public class VehicleInstanceJSONModelTest {
    ...
    void shouldBeEqualWhenDataIsSameRegardlessOfId() {
        VehicleInstanceJSONModel vehicle1 = TestDataFactory.createVehicleInstance(1L, "1234ABC", "CHASSIS-1");
    ...
    void shouldNotBeEqualWhenPlateChanges() {
        VehicleInstanceJSONModel vehicle1 = TestDataFactory.createVehicleInstance(1L, "1234ABC", "CHASSIS-1");
        VehicleInstanceJSONModel vehicle2 = TestDataFactory.createVehicleInstance(1L, "9999XYZ", "CHASSIS-1");
    ...
    void hashCodeShouldAlwaysBePositive() {
        VehicleInstanceJSONModel vehicle = TestDataFactory.createVehicleInstance(1L, "1234ABC", "CH-1");
    ...
    void equalsShouldBeSymmetric() {
        VehicleInstanceJSONModel vehicle1 = TestDataFactory.createVehicleInstance(1L, "1234ABC", "CH-1");
    ...
    void testEqualsFullCoverage() {
        VehicleInstanceJSONModel vehicle = TestDataFactory.createVehicleInstance(1L, "A", "B");
