...
@Data
@Schema(title="The CarModel JSON object", description="This object represents the OEM version of a car as new." )
public class VehicleModelJSONModel implements Serializable {
    ...
    private KeyValueJSONModel bodyType;
    ...
    private KeyValueJSONModel changeType;
    @Schema(description = "Fuel type")
    private KeyValueJSONModel fuelType;
    @Schema(description = "Number of seats")
    private Integer numSeats;
    @Schema(description = "Drivetrain type")
    private KeyValueJSONModel drivetrainType;
    @Schema(description = "Environmental badge")
    private KeyValueJSONModel environmentalBadge;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VehicleModelJSONModel)) return false;
        VehicleModelJSONModel other = (VehicleModelJSONModel) o;
