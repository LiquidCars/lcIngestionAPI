...
@NoArgsConstructor
@AllArgsConstructor
@Schema(title="The CarInstanceEquipment XML object", description="This object represents an optional equipment included in a give car" )
public class CarInstanceEquipmentXMLModel implements Serializable {
    @JsonIgnore
    private long vehicleInstanceId;
    @Schema(description = "internal ID")
    private int id;
    @Schema(description = "The equipment label")
    private KeyValueXMLModel equipment;
    @Schema(description = "The equipment category")
    private KeyValueXMLModel category;
    @Schema(description = "The equipment type")
    private KeyValueXMLModel type;
