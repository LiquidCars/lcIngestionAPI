...
@NoArgsConstructor
@AllArgsConstructor
@Schema(title="The CarOfferResource JSON object", description="This object represents a multimedia resource associated with car offers" )
public class CarOfferResourceJSONModel implements Serializable {
    ...
    private KeyValueJSONModel<String,String> type;
