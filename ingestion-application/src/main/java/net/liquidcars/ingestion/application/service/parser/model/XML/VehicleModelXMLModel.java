...
@Data
@Schema(title="The CarModel XML object", description="This object represents the OEM version of a car as new." )
public class VehicleModelXMLModel implements Serializable {
    ...
    private KeyValueXMLModel bodyType;
    ...
    private KeyValueXMLModel changeType;
    @Schema(description = "Fuel type")
    private KeyValueXMLModel fuelType;
    @Schema(description = "Number of seats")
    private Integer numSeats;
    @Schema(description = "Drivetrain type")
    private KeyValueXMLModel drivetrainType;
    @Schema(description = "Environmental badge")
    private KeyValueXMLModel environmentalBadge;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VehicleModelXMLModel)) return false;
